...
export const DOM = {
  ...
  qualityStatusDimensionsWrap: document.getElementById("quality-status-dimensions-wrap"),
  qualityStatusDimensions: document.getElementById("quality-status-dimensions"),
  qualityStatusStrengthsWrap: document.getElementById("quality-status-strengths-wrap"),
  qualityStatusStrengths: document.getElementById("quality-status-strengths"),
  qualityStatusImprovementsWrap: document.getElementById("quality-status-improvements-wrap"),
  qualityStatusImprovements: document.getElementById("quality-status-improvements"),
